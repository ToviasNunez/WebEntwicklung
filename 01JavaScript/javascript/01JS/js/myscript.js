function getName() {
  let value01 = document.getElementById("myName").value;
  return value01;
}
...
function getAge() {
  let value = document.getElementById("myAge").value;
  return value;
}
...
function getInfo() {
  ...
  if (age == magicNumber) {
    document.write("Name: " + getName() + " Age: " + getAge());
    document.write(
      "Congratulation you have typed the magic number ." + magicNumber
    );
  } else {
    document.write("Name: " + getName() + " Age: " + getAge());
    if (age < 50) {
      document.write(" The age under 50");
    } else {
      // document.write("Name: " + getName() + " Age: " + getAge());
      document.writeln(" The age over 50");
    }
  }
}
...
const car = ["Ford", "BMB", "Audi"];

// using of in one erray
for (let i of car) {
  console.log(i);
}
...
for (let key in rgb) {
  console.log(key); // 0 1 2 print the key from the array
}

for (let value of rgb) {
  console.log(value); // red green blue  print the value from the element
}

console.log("getting the vaule from the array using the key ");
for (let key in rgb) {
  if (Object.hasOwnProperty.call(rgb, key)) {
    const element = rgb[key];
    console.log(element);
  }
}
...
let foo = {};
let bar = { name: "Tovias", age: 23, state: "California" };
...
let first_name = "tovias";
let myAge = 23;

let person1 = concat(first_name, myAge);
console.log(person1);
...
// work with the box --> not really working

function changSytleBox() {
...
function changeStyle01(url) {
  var stylesheet = document.getElementById("stylesheet");
  stylesheet.setAttribute("href", url);
}

function changeColorParas() {
  let allParas = document.getElementsByTagName("p");
  for (let index = 0; index < allParas.length; index++) {
    allParas[index].style.backgroundColor = "orange";
  }
}

// combination id and target
function changeStyleAddress() {
  let addParas = document.getElementById("address").getElementsByTagName("p");
  for (let index = 0; index < addParas.length; index++) {
    addParas[index].style.backgroundColor = "yellow";
  }
}

// Asychronous Programmierung

//console.log("I like javaschript ");
...
console.log("program start", f);

console.log("program start", f2);
...
function createPar() {
  var element = document.createElement("p");
  element.textContent = " this is new paragraph";
  document.body.appendChild(element);
}
